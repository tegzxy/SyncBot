...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289503294960:+62 895-0329-4960\n' // JANGAN KEK BABI SU
...
const config = {
    A187: '👾SYNCBOT👾', // TOBAT SU ASU
    instagram: 'https://www.instagram.com/tegarxzy/', // INFO JANGAN DI UBAH
    nomer: 'wa.me/6289503294960', // INFO SU JNGAN DI UBAH
    youtube: 'https://youtube.com/channel/UCFaHS_ftqomp2LYSoz15NAg', // KINTIL
    whatsapp: '𝐒𝐲𝐧𝐜𝐗𝐭𝐞𝐭𝐡𝐢𝐜', // BABI
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6289503294960@s.whatsapp.net"] // ganti nomer lu
...
break
       ...
       client.sendMessage(from, '𝗧𝘂𝗵 𝗱𝗮𝗵 𝗮𝗸𝘂 𝗸𝗮𝘀𝗶𝗵 𝗻𝗼𝗺𝗲𝗿 𝗖𝗢 👾𝗦𝗬𝗡𝗖𝗕𝗢𝗧👾,𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗗𝗜 𝗦𝗔𝗩𝗘 𝗘𝗔 ><',MessageType.text, { quoted: mek} )
           break    
           case 'demote':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
